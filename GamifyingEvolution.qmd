...
Twin3<- read.csv("Twin/geneWriteFile3.csv")


df_parents <- Twin3 %>%
  select(Parent.One, Parent.Two, Wave.Number) %>%
  pivot_longer(cols = -Wave.Number, names_to = "parent_type", values_to = "parent_id")

# Count the number of offspring for each parent
offspring_counts <- df_parents %>%
  group_by(parent_id, Wave.Number) %>%
  summarise(offspring_count = n(), .groups = "drop")

offspring_counts <- na.omit(offspring_counts)


offspring_counts<- rename(offspring_counts, Slime.ID = parent_id)
offspring_counts <- offspring_counts %>%
  filter(!is.na(Slime.ID)) %>%
  mutate(Slime.ID = as.numeric(Slime.ID))


Twin3 <- Twin3 %>%
  left_join(offspring_counts, by = c("Wave.Number", "Slime.ID"))%>%
...
ggplot(Twin3, aes(x=Wave.Number, y= Main.Resistance.Trait))+
  geom_point(aes(x=Wave.Number, y= Main.Resistance.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Secondary.Resistance.Trait))+
  geom_point(aes(x=Wave.Number, y= Secondary.Resistance.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)
...
ggplot(Twin3, aes(x=Wave.Number, y= Tower.Attraction.Trait))+
  geom_point(aes(x=Wave.Number, y= Tower.Attraction.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Slime.Optimal.Distance.Trait))+
  geom_point(aes(x=Wave.Number, y= Slime.Optimal.Distance.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Speed.Trait))+
  geom_point(aes(x=Wave.Number, y= Speed.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)
...
ggplot(Twin3, aes(x=Wave.Number, y= Turn.Rate.Trait))+
  geom_point(aes(x=Wave.Number, y= Turn.Rate.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Slime.View.Range.Trait))+
  geom_point(aes(x=Wave.Number, y= Slime.View.Range.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Tower.View.Range.Trait))+
  geom_point(aes(x=Wave.Number, y= Tower.View.Range.Trait, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)

ggplot(Twin3, aes(x=Wave.Number, y= Player.Distance.Fitness))+
  geom_point(aes(x=Wave.Number, y= Player.Distance.Fitness, color = Main.Type, size = offspring_count/10),
             alpha =0.2)+
  geom_smooth()+
  facet_wrap(~Main.Type)
