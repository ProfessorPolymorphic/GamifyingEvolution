...
Twin2Babies <- Twin2%>%
  group_by(Slime.ID, Wave.Number)%>%
  summarize(Babies = n(Parent.One=Slime.ID))
...
ggplot(Twin2, aes(x=Wave.Number, y= Speed.Trait))+
  geom_point(aes(x=Wave.Number, y= Speed.Trait, color = Main.Type))+
  geom_smooth()
